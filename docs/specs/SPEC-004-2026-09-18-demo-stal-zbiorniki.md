...
| 2026-09-19 | Agent Developer (spec wykonania, EX-P0): zmianę na stronie robi agent OpenCode w jednorazowym kontenerze z node, a szuflada zadania pokazuje diff, checki i podgląd przed „Zatwierdź i opublikuj”. |
