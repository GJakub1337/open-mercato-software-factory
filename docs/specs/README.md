...
| [005](./SPEC-005-2026-09-19-stal-zbiorniki-www.md) | 2026-09-19 | Strona Stal-Zbiorniki, docelowe repo fabryki na demo | Draft | Statyczna strona producenta, gdzie produkt to plik w repo: PR per nowy zbiornik, preview per PR, test Playwright sterowany danymi, ścieżki zmapowane na klasy recenzji (`content` → waiver, `legal` → prawnik) |
